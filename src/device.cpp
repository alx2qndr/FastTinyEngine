...
namespace fte
{
    ...
    void Device::createInstance()
    {
        ...
        appInfo.pApplicationName = "Vulkan Rendering Application";
    ...
    void Device::pickPhysicalDevice()
    {
        ...
        if (!candidates.empty() && candidates.rbegin()->first > 0)
        {
            ...
            std::cout << "Selected Device: " << selectedProps.deviceName << " (Score: " << candidates.rbegin()->first
                      << ")\n";
        }
        else
        {
    ...
    int Device::ratePhysicalDeviceSuitability(VkPhysicalDevice device)
    {
        int score = 0;
        ...
        // Тип устройства: дискретная GPU получает большой бонус
    ...
    {
        QueueFamilies queueFamilyIndices = findQueueFamilies();
    ...
    {
        if (!window.createSurface(instance, &surface, nullptr))
        {
    ...
    void Device::checkRequiredInstanceExtensions()
    {
        uint32_t extensionCount = 0;
    ...
    bool Device::checkPhysicalDeviceExtensionSupport(VkPhysicalDevice device)
    {
    ...
    QueueFamilies Device::findQueueFamilies(VkPhysicalDevice device) const
    {
    ...
    SwapchainSupportInfo Device::querySwapchainSupport(VkPhysicalDevice device)
    {
    ...
    void Device::createImage(uint32_t width,
                             ...
                             const VkImageCreateInfo *customImageInfo)
    {
